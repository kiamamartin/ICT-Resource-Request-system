    ...
    var SignaturePad = (function () {
        ...
        SignaturePad.prototype._fromData = function (pointGroups, drawCurve, drawDot) {
            for (var _i = 0, pointGroups_1 = pointGroups; _i < pointGroups_1.length; _i++) {
                ...
                if (points.length > 1) {
                    ...
                    this._reset();
                    var point = points[0];
                    var newPoint = new Point(point.x, point.y, point.time);
                    this.penColor = color;
                    this._strokeBegin(newPoint);
                    this._strokeEnd(newPoint);
                }
            }
        };
        SignaturePad.prototype._toSVG = function () {
            ...
            this._fromData(pointGroups, function (curve) {
                ...
                var str = "M " + curve.startPoint.x.toFixed(3) + "," + curve.startPoint.y.toFixed(3) + " " +
